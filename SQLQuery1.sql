...
SELECT c.Firstname, c.Lastname, o.ProductID
FROM StoredDb.Orders as o
	JOIN StoredDb.Customers AS c on o.CustomerID = c.ID
WHERE c.Firstname = 'Tina' AND c.Lastname = 'Smith' 


-- report all revenues generated by sales of iphones
SELECT SUM(p.Price)
FROM StoredDb.Orders as o
	JOIN StoredDb.Products AS p on o.ProductID = p.ID
WHERE p.Name = 'IPhone'


-- increase price of Iphone to 250$
UPDATE StoredDb.Products
SET Price = 250.00
WHERE Name = 'Iphone';